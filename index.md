...
Automated reading pipeline for cybersecurity consulting and audit work. Daily digests each weekday morning, podcast notes on Saturdays, a research brief on the 1st of the month. Files older than 30 days are removed automatically.
...
{% endfor %}
{% else %}
_No notes yet — generated on Saturdays._
{% endif %}
